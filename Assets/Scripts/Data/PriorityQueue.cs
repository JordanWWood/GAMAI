...
// Thank you James McCaffrey for his demonstration of an optimised priority queue
...
namespace PriorityQueues {
    ...
    public class PriorityQueueObject : IComparable<PriorityQueueObject> {
        public float Weight;
        public NavNode Item;

        public PriorityQueueObject(NavNode node, float weight) {
            Weight = weight;
            Item = node;
        }
